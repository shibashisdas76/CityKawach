    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {departments.map((dept) => {
          ...
          return (
            <div key={dept.id} className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-4 flex flex-col justify-between hover:border-slate-300 transition-all">
              <div className="space-y-3.5">
                <div className="flex justify-between items-start border-b border-slate-100 pb-3">
                  <div>
                    ...
                    <h3 className="text-base font-bold text-slate-900 mt-1.5 tracking-tight">{dept.name}</h3>
                  </div>
                  <span className="px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-mono font-semibold flex items-center space-x-1 border border-emerald-200">
                ...
                <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 flex justify-between items-center text-xs font-mono">
              ...
              <div className="pt-3 border-t border-slate-100 flex justify-between items-center">
                ...
                <Link
                  to={`/cameras`}
                  className="px-3.5 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs transition inline-flex items-center gap-1.5 shadow-sm"
                >
